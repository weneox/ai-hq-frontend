    ...
    <div className="min-h-screen overflow-x-clip bg-[#02050c] text-white selection:bg-cyan-300/20 selection:text-white">
      ...
      <div className="relative min-h-screen md:pl-[86px]">
        ...
        <main className="px-4 pb-4 pt-4 md:px-6 md:pb-6 md:pt-5">
          <section className="relative min-h-[calc(100vh-124px)] overflow-hidden rounded-[34px] border border-white/[0.07] bg-[linear-gradient(180deg,rgba(8,13,26,0.94),rgba(4,8,18,0.98))] shadow-[0_30px_120px_rgba(0,0,0,0.42),inset_0_1px_0_rgba(255,255,255,0.05)]">
            ...
            <div className="relative h-full p-4 md:p-6 xl:p-7 2xl:p-8">
              <div className="relative h-full min-h-[calc(100vh-180px)] rounded-[28px] border border-white/[0.045] bg-[linear-gradient(180deg,rgba(255,255,255,0.02),rgba(255,255,255,0.008))] p-3 shadow-[inset_0_1px_0_rgba(255,255,255,0.03)] md:p-4 xl:p-5">
