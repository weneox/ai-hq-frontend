...
export default function SetupStudioRefineModal({
  ...
  return (
    <motion.div
      ...
      className="relative mx-auto w-full max-w-[980px] overflow-hidden rounded-[32px] border border-white/80 bg-white/92 shadow-[0_40px_120px_rgba(15,23,42,0.12)] backdrop-blur-2xl"
    >
      ...
      <div className="grid gap-8 px-5 py-5 sm:px-6 lg:grid-cols-[1.08fr_0.92fr]">
        ...
        <div>
          ...
          <div className="mt-6 rounded-[24px] border border-slate-900/8 bg-slate-50/90 p-4">
            ...
            <div className="mt-3 space-y-2 text-sm leading-7 text-slate-600">
              <div>Services: <span className="text-slate-900">Name | Description</span></div>
              <div>FAQ: <span className="text-slate-900">Question | Answer</span></div>
              <div>Policies: <span className="text-slate-900">Title | Description</span></div>
            </div>
          </div>
        </div>
      </div>
