// src/components/layout/Header.jsx (FINAL — Pins to absolute top, no drift)
...
export default function Header({ onOpenSidebar }) {
  ...
  const live = useMemo(
    () => ({ ws: true, mode: "manual", daily: "10:00", db: "stable" }),
    []
  );
  ...
  return (
    <>
      {/* ✅ REAL TOP PIN (no outer padding here) */}
      <header className="sticky top-0 z-[60]">
        {/* ✅ safe-area + tiny breathing space WITHOUT pushing sticky down */}
        <div className="pt-0">
          <div className="mx-auto max-w-[1400px] px-3 sm:px-4">
            {/* ✅ floating card: margin-top gives vibe but doesn't break top pin */}
            <div className="pt-3">
              <div
                className={cx(
              ...
              >
                ...
                <div className="relative z-10 grid grid-cols-[auto,1fr,auto] items-center gap-3 px-4 sm:px-5 py-4">
                  ...
                  <div className="flex items-center gap-2">
                    <IconButton
                      title="Notifications"
                      onClick={() => alert("Later: notifications")}
                    >
                    ...
                    <PrimaryButton
                      onClick={() => alert("Later: run daily draft")}
              ...
              {/* ✅ spacer: keeps content from sticking under header (optional) */}
              <div className="h-3" />
            </div>
          </div>
        </div>
